...
export const projects: Project[] = [
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/S-SamarthBhatt-B/Summer-Training-Data-Science',
    status: 'completed',
    year: '2025',
  },
  {
  ...
  },
  {
    id: 'cosmosdesk',
    title: 'CosmosDesk',
    tagline: 'Details coming soon', // TODO: replace with a real one-line tagline
    description: 'Description coming soon — ask Samarth for a quick summary of what this project does and why he built it.',
    stack: [],
    features: ['Full feature list coming soon'],
    githubUrl: 'https://github.com/S-SamarthBhatt-B/CosmosDesk',
    status: 'completed',
    year: '2026',
  },
  {
    id: 'solar-system-project',
    title: 'Solar System Project',
    tagline: 'Details coming soon', // TODO: replace with a real one-line tagline
    description: 'Description coming soon — ask Samarth for a quick summary of what this project does and why he built it.',
    stack: [],
    features: ['Full feature list coming soon'],
    githubUrl: 'https://github.com/S-SamarthBhatt-B/Solar-System-Project',
    status: 'completed',
    year: '2026',
  },
  {
    id: 'datacanvas',
    title: 'DataCanvas',
    tagline: 'Details coming soon', // TODO: replace with a real one-line tagline + GitHub link
    description: 'Description coming soon — ask Samarth for a quick summary of what this project does and why he built it.',
    stack: [],
    features: ['Full feature list coming soon'],
    status: 'in-progress',
